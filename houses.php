						...
						<table class="table table-bordered table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td class="">
										<p>Bed #: <b><?php echo $row['house_no'] ?></b></p>
										<p><small>Room #: <b><?php echo $row['cname'] ?></b></small></p>
										<p><small>Price: <b><?php echo number_format($row['price'],2) ?></b></small></p>
									</td>
									<td class="text-center">
										<button class="btn btn-sm btn-primary edit_house" type="button" data-id="<?php echo $row['id'] ?>"  data-house_no="<?php echo $row['house_no'] ?>" data-category_id="<?php echo $row['category_id'] ?>" data-price="<?php echo $row['price'] ?>" >Edit</button>
...
<script>
	...
	$('.delete_house').click(function(){
		_conf("Are you sure to delete this room?","delete_house",[$(this).attr('data-id')])
	})
