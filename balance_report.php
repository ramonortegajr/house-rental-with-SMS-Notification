						...
						<div class="row">
							<table class="table table-bordered">
								...
								<tbody>
									...
									$i = 1;
									// $tamount = 0;
									$tenants =$conn->query("SELECT t.*,concat(t.lastname,', ',t.firstname,' ',t.middlename) as name,h.house_no,h.price, c.name as room FROM tenants t inner join houses h on h.id = t.house_id INNER JOIN categories c ON h.category_id = c.id where t.status = 1 order by h.house_no desc ");
