            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                            ...
                            <div class="card border-primary">
                                <div class="card-body bg-primary">
                                    <div class="card-body text-white">
                                        ...
                                        <h4><b>
                                            <?php echo $conn->query("SELECT * FROM houses GROUP BY category_id")->num_rows ?>
                                        </b></h4>
                                        <p><b>Total Rooms</b></p>
                                    </div>
                                </div>
                                <div class="card-footer">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <a href="index.php?page=houses" class="text-primary float-right">View Rooms<span class="fa fa-angle-right"></span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="card" style="border-color:darkcyan;">
                                ...
                                <div class="card-footer">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <a href="index.php?page=houses" class="text-primary float-right">View Beds <span class="fa fa-angle-right"></span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="card border-success">
                                <div class="card-body bg-success">
                                    <div class="card-body text-white">
                                        <span class="float-right summary_icon"> <i class="fa fa-wallet "></i></span>
                                        <h4><b>
                                            <?php 
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="card" style="border-color:dimgray;">
                                <div class="card-body" style="background-color:dimgray;">
                                    <div class="card-body text-white">
                                        <span class="float-right summary_icon"> <i class="fa fa-database "></i></span>
                                        <h4><b>
                                            <?php echo $conn->query("SELECT * FROM payments")->num_rows ?>
                                        </b></h4>
                                        <p><b>Collectibles</b></p>
                                    </div>
                                </div>
                                <div class="card-footer">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <a href="index.php?page=invoices" class="text-primary float-right">View Collectibles <span class="fa fa-angle-right"></span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="card" style="border-color:indianred;">
                                <div class="card-body" style="background-color:indianred;">
                                    <div class="card-body text-white">
                                        ...
                                        <h4><b>
                                        <?php 
                                             $payment = $conn->query("SELECT count(suggestion_text) as suggest FROM suggestion"); 
                                             echo $payment->num_rows > 0 ? number_format($payment->fetch_array()['suggest']) : 0;
                                             ?>
                                        </b></h4>
                                        <p><b>Suggestions</b></p>
                                    </div>
                                ...
                                <div class="card-footer">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <a href="index.php?page=suggestions" class="text-primary float-right">View Suggestions <span class="fa fa-angle-right"></span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
