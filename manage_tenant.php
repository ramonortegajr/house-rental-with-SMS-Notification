	...
	<form action="" id="manage-tenant">
		...
		<div class="form-group row">
			...
			<div class="col-md-4">
				...
				<input type="text" class="form-control" name="blood"  value="<?php echo isset($blood) ? $blood :'' ?>" required>
		</div>
		</div>
		...
		<div class="col-md-4">
				<label for="" class="control-label">Parents Name</label>
				<input type="text" class="form-control" name="parents"  value="<?php echo isset($parents) ? $parents :'' ?>" required>
		</div>

		<div class="col-md-4">
				<label for="" class="control-label">Parents Contact</label>
				<input type="text" class="form-control" name="parents_contact"  value="<?php echo isset($parents_contact) ? $parents_contact :'' ?>" required>
		</div>
		</div>
